...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dropboxdrivefs-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9846&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dropboxdrivefs-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dropboxdrivefs` can be installed with:

```
conda install dropboxdrivefs
```

It is possible to list all of the versions of `dropboxdrivefs` available on your platform with:
